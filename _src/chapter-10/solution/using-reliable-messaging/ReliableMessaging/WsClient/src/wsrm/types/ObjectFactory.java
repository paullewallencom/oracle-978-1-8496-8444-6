 ...
 * generated in the wsrm.types package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloOneWay_QNAME = new QName("http://wsrm.osbbook", "sayHelloOneWay");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wsrm.types
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsrm.osbbook", name = "sayHelloOneWay")
